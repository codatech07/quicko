...
exports.getMe = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json({ status: "success", message: "Data retrieved successfully", user });
});
...
exports.updateMe = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json({ status: "success", message: "Data updated successfully", user });
});
// CHANGE PASSWORD
...
exports.getUserById = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json({ status: "success", message: "User retrieved successfully", user });
});
